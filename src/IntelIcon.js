...
import './IntelIcon.css';


class IntelIcon extends React.Component{

    render(){
        return <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 128 128" >
                <g>
	                <path className= "st0" d="M0,128V0h128v128H0z" fill="none" />
	                <g>
	                	<g id="surface1">
	                		<path className="st1" d="M68.5,3.6c-23.8,0-43.2,18.1-43.2,40.2c0,10.5,6.3,18.4,12.4,26c4.9,6.1,9.5,11.9,10.3,18.5v14.8
	                			...
	                			l21.3-2.5c-1.9,3.5-5.7,5.9-10.2,5.9H64c-6.3,0-11.4-4.7-11.4-10.6v-0.2L84.5,99.2z M66.3,118h4.5v2.1h-4.5V118z" fill="#ffffff"/>
	                	</g>
	                </g>
                </g>
            </svg>
